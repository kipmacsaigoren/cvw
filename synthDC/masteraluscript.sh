...
make synth DESIGN=alu TECH=tsmc28psyn CONFIG=rv32i FREQ=10000 MAXOPT=1 TITLE=$FREQ
...
make synth DESIGN=alu TECH=tsmc28psyn CONFIG=rv64i FREQ=10000 MAXOPT=1 TITLE = $FREQ
...
sed -i '151s/.*/`define ZBC_SUPPORTED 0/' $rv32i
sed -i '152s/.*/`define ZBS_SUPPORTED 0/' $rv32i
make synth DESIGN=alu TECH=tsmc28psyn CONFIG=rv32i FREQ=10000  TITLE = $FREQ
...
sed -i '153s/.*/`define ZBC_SUPPORTED 0/' $rv64i
sed -i '154s/.*/`define ZBS_SUPPORTED 0/' $rv64i
make synth DESIGN=alu TECH=tsmc28psyn CONFIG=rv64i FREQ=10000  TITLE = $FREQ
...
#cores
make synth DESIGN=wallypipelinedcore TECH=tsmc28psyn CONFIG=rv64i FREQ=10000
make synth DESIGN=wallypipelinedcore TECH=tsmc28psyn CONFIG=rv64i FREQ=10000
